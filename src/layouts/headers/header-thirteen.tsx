          ...
          <div className="row align-items-center">
            <div className="col-xl-2 col-lg-2 col-md-6 col-6">
              <div className="tp-inner-header-logo tp-header-logo">
                <Link href="/">
                  <Image src="/assets/fakhruddin-img/fakhruddin-logo-f.webp" alt="logo" width={150} height={47} style={{filter: 'brightness(0) invert(1)'}} />
                </Link>
              </div>
            </div>
...
export default function HeaderThirteen({transparent=false,cls=''}: IProps) {
